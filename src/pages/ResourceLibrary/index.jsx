  ...
  return (
    <div>
      ...
      <Row className={`${styles.container}websitecontainer`}>
        ...
        <h3 className={styles.rh3}>Explore our comprehensive articles section</h3>
        <Col md={4} className={styles.articalboxed}>
          <Row>
            <Col>
              <div className={`${styles.card} mb-3`} onClick={() => handleCardClick("f5c4ce07-51b5-421d-9c17-672d2752e306", "407f7ce3-3b15-4feb-a36f-c1e1cf2a131f")}>
                <div className={`${styles.row} g-0`}>
                  ...
                  <div className={`${styles.col}md-8`}>
                    <div className={`${styles.card}body`}>
                      <p>
                        <h5 className={styles.articalh5}>A Breath Stuck: Me and My Depression</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
            ...
            <Col>
              <div class="card mb-3 rcard" onClick={() => handleCardClick("f5c4ce07-51b5-421d-9c17-672d2752e306", "407f7ce3-3b15-4feb-a36f-c1e1cf2a131f")} >
                <div class="row g-0">
                  <div class="col-md-4">
                    <img
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <p>
                        <h5 className={styles.articalh5}>Walking on a Tight Rope: Coping with Depression</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
              ...
              <div className={`${styles.card}mb-3`} onClick={() => handleCardClick("f5c4ce07-51b5-421d-9c17-672d2752e306", "407f7ce3-3b15-4feb-a36f-c1e1cf2a131f")} >
                <div className={`${styles.row}g-0`}>
                  ...
                  <div className={`${styles.col}md-8`}>
                    <div className={`${styles.card}body`}>
                      <p>
                        <h5 className={styles.articalh5}>My Story With Bipolar Disorder</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
            ...
            <Col>
              <div class="card mb-3 rcard" onClick={() => handleCardClick("f5c4ce07-51b5-421d-9c17-672d2752e306", "407f7ce3-3b15-4feb-a36f-c1e1cf2a131f")} >
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <p> <h5 className={styles.articalh5}>Helping Someone with an Eating Disorder</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
            ...
            <Col>
              <div class="card mb-3 rcard">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <p> <h5 className={styles.articalh5}>The effect of ADHD on the life of an individual, their family, and community from preschool to adult life</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
            ...
            <Col>
              <div class="card mb-3 rcard">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <p> <h5 className={styles.articalh5}>What is ADHD?</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
            ...
            <Col>
              <div class="card mb-3 rcard">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <p> <h5 className={styles.articalh5}>College Students and Eating Disorders</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
            ...
            <Col>
              <div class="card mb-3 rcard">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <p> <h5 className={styles.articalh5}>Taking a Bite Out of Eating Disorders: Facts and Myths</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <p> <h5 className={styles.articalh5}>My Story With Bipolar Disorder</h5>
                        <button
                          className={styles.articalabtn}
                          onClick={async () => {
        ...
        <h3 className={styles.rh3}> Explore a world of knowledge and healing within our carefully curated Books section, where you'll find an array of insightful literature to empower your mental well-being journey.</h3>
        <Col md={4} className={styles.bookboxed}>
          <Row>
            <Col>
              <div class="card mb-3 rcard">
                <div class="row g-0">
