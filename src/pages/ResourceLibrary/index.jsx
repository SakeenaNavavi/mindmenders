...
const supabase = createClient('https://brxyhorsxcsfbiivubin.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJyeHlob3JzeGNzZmJpaXZ1YmluIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTkxNjAyMTQsImV4cCI6MjAxNDczNjIxNH0._RS1Z6BydY99zFyVtseR1HKH_KNVSOU1IsPj7i019l0');

const ResourceLibrary = () => {
  const [selectedtblResources, setSelectedtblResources] = useState(null);
  const [selectedtblMentalHealthConditions, setSelectedtblMentalHealthConditions] = useState(null);

  const openYoutubeVideo = (videoUrl) => {
    window.open(videoUrl, '_blank');
  };

  const saveTotblVisitorResources = async (videoUrl) => {
    if (selectedtblResources && selectedtblMentalHealthConditions) {
      try {
        console.log('Selected Resource:', selectedtblResources);
        console.log('Selected Condition:', selectedtblMentalHealthConditions);

        // Perform the Supabase insert or update operation here
        const { data, error } = await supabase
          .from('tblVisitorResources')
          .upsert([
            {
              resource_id: selectedtblResources,
              condition_id: selectedtblMentalHealthConditions,
            },
          ]);

        if (error) {
          console.error('Error saving to tblVisitorResources:', error.message);
        } else {
          console.log('Data saved successfully to tblVisitorResources:', data);

          // Reset selectedResource and selectedCondition after saving
          setSelectedtblResources(null);
          setSelectedtblMentalHealthConditions(null);

          // Open the YouTube video after saving
      ...
      console.error('Please select a resource and a condition before saving.');
    }
  };
          ...
          <Row>
            ...
            <Col>
              ...
              <button
                ...
                onClick={() => {
                  saveTotblVisitorResources('https://www.youtube.com/embed/fWFuQR_Wt4M?si=lW5Rx3jPQzXEl32m');
                  openYoutubeVideo('https://www.youtube.com/embed/fWFuQR_Wt4M?si=lW5Rx3jPQzXEl32m')
                }}
              >
                Watch Video
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://www.youtube.com/watch?v=tJQRsIbD110');
...
>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/yVKaphs9sPU?si=hEAOEL12WJN6HsEc');
    openYoutubeVideo('https://youtu.be/yVKaphs9sPU?si=hEAOEL12WJN6HsEc');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/KSClXw4Wfxs?si=fIdo-ZBQMivIXcA0');
    openYoutubeVideo('https://youtu.be/KSClXw4Wfxs?si=fIdo-ZBQMivIXcA0');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/BVJkf8IuRjE?si=eBr_GeJ-P2QhAya-');
    openYoutubeVideo('https://youtu.be/BVJkf8IuRjE?si=eBr_GeJ-P2QhAya-');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/QLjPrNe63kk?si=YX0YUQC5fk_01OJ3');
    openYoutubeVideo('https://youtu.be/QLjPrNe63kk?si=YX0YUQC5fk_01OJ3');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/w_2STJAJhJM?si=Z7XqqB8nrqq9xHTE');
    openYoutubeVideo('https://youtu.be/w_2STJAJhJM?si=Z7XqqB8nrqq9xHTE');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/zTuX_ShUrw0?si=aNW2QhuKZVFPSPnX');
    openYoutubeVideo('https://youtu.be/zTuX_ShUrw0?si=aNW2QhuKZVFPSPnX');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/f9yCYlV-gNM?si=7isN-HDgQGlxAhY3');
    openYoutubeVideo('https://youtu.be/f9yCYlV-gNM?si=7isN-HDgQGlxAhY3');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/AlMfEL_sCYI?si=-TntfTC82b8KzMBN');
    openYoutubeVideo('https://youtu.be/AlMfEL_sCYI?si=-TntfTC82b8KzMBN');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/e7OpB6xy83Y?si=jsz-z6xF-rmypY1w');
    openYoutubeVideo('https://youtu.be/e7OpB6xy83Y?si=jsz-z6xF-rmypY1w');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/v-t1Z5-oPtU?si=dTSLHcZtfhD863SE');
    openYoutubeVideo('https://youtu.be/v-t1Z5-oPtU?si=dTSLHcZtfhD863SE');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/vdc8JonEax8?si=sIkS28IUA5gOMEXb');
    openYoutubeVideo('https://youtu.be/vdc8JonEax8?si=sIkS28IUA5gOMEXb');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/WVPtF7gr1jw?si=QpsZ0qohm8CkRzNt');
    openYoutubeVideo('https://youtu.be/WVPtF7gr1jw?si=QpsZ0qohm8CkRzNt');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/gIwU5INBV_0?si=Lxks5Scf8qPJQa19');
    openYoutubeVideo('https://youtu.be/gIwU5INBV_0?si=Lxks5Scf8qPJQa19');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/_tXFhGRqggc?si=Fp69UDW-IhzfyUI_');
    openYoutubeVideo('https://youtu.be/_tXFhGRqggc?si=Fp69UDW-IhzfyUI_');
  }}
>
  Watch Video
</button>
...
>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/oGqu_U0EI8c?si=oNt7flzvP0KxsOAY');
    openYoutubeVideo('https://youtu.be/oGqu_U0EI8c?si=oNt7flzvP0KxsOAY');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/oGqu_U0EI8c?si=ZZkyIGR7M54LM3NH');
    openYoutubeVideo('https://youtu.be/oGqu_U0EI8c?si=ZZkyIGR7M54LM3NH');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/TZ9FNL1iI54?si=eJjnZX9eMjNmdqGn');
    openYoutubeVideo('https://youtu.be/TZ9FNL1iI54?si=eJjnZX9eMjNmdqGn');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/NU9ajgqYag8?si=SVqZMKl22ltDXGBI');
    openYoutubeVideo('https://youtu.be/NU9ajgqYag8?si=SVqZMKl22ltDXGBI');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/yQumuTeDMC4?si=4lZp_PT58ZkMwSyZ');
    openYoutubeVideo('https://youtu.be/yQumuTeDMC4?si=4lZp_PT58ZkMwSyZ');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/aBl6-UTvmn8?si=nWuLuKGPfm3u2JFA');
    openYoutubeVideo('https://youtu.be/aBl6-UTvmn8?si=nWuLuKGPfm3u2JFA');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/DRQe8NcqvVY?si=JLcVIQBH7EvfgyMo');
    openYoutubeVideo('https://youtu.be/DRQe8NcqvVY?si=JLcVIQBH7EvfgyMo');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/3Bax8ijH038?si=TCM4dXil6N7mnmsU');
    openYoutubeVideo('https://youtu.be/3Bax8ijH038?si=TCM4dXil6N7mnmsU');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/MsSXh1BxLjE?si=Im3yCNm0oRcRqdig');
    openYoutubeVideo('https://youtu.be/MsSXh1BxLjE?si=Im3yCNm0oRcRqdig');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/G9vkGCo7Gtg?si=oriUZWz1r_Yhz-MC');
    openYoutubeVideo('https://youtu.be/G9vkGCo7Gtg?si=oriUZWz1r_Yhz-MC');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/KSvk8LLBo2g?si=t5t4rqddQ_HahCB9');
    openYoutubeVideo('https://youtu.be/KSvk8LLBo2g?si=t5t4rqddQ_HahCB9');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/AM7vf5HJxaQ?si=nmeVDsPUZX_Ju8E8');
    openYoutubeVideo('https://youtu.be/AM7vf5HJxaQ?si=nmeVDsPUZX_Ju8E8');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/ZwMlHkWKDwM?si=xk6t0FejpUXku2DO');
    openYoutubeVideo('https://youtu.be/ZwMlHkWKDwM?si=xk6t0FejpUXku2DO');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/PCOg2G797ek?si=vwgjfKEOJduaTGgW');
    openYoutubeVideo('https://youtu.be/PCOg2G797ek?si=vwgjfKEOJduaTGgW');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/oWtVbDs1gkU?si=RTFk8CI97OE7e_DY');
    openYoutubeVideo('https://youtu.be/oWtVbDs1gkU?si=RTFk8CI97OE7e_DY');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/E705zO58SnQ?si=BlpWuJ5ZKt5QLXO7');
    openYoutubeVideo('https://youtu.be/E705zO58SnQ?si=BlpWuJ5ZKt5QLXO7');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/wVTvcxEWClg?si=ewk_8b1LYwC8sGJc');
    openYoutubeVideo('https://youtu.be/wVTvcxEWClg?si=ewk_8b1LYwC8sGJc');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/hC085F1rEDg?si=TQVfpd0ztUAQ3HuT');
    openYoutubeVideo('https://youtu.be/hC085F1rEDg?si=TQVfpd0ztUAQ3HuT');
  }}
>
  Watch Video
</button>
  ...
  className="youtubrbutton"
  onClick={() => {
    saveTotblVisitorResources('https://youtu.be/I7QGn1Ri9cg?si=wUOd_7mRHhyCQ3qz');
    openYoutubeVideo('https://youtu.be/I7QGn1Ri9cg?si=wUOd_7mRHhyCQ3qz');
  }}
>
  Watch Video
</button>
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <a
          className="articala"
          href="https://www.voicesofyouth.org/blog/breath-stuck-me-and-my-depression"
         >
  ...
  <div class="card mb-3 librarycard" >
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">Walking on a Tight Rope: Coping with Depression</h5>
        <a className= "articala" 
        href="https://www.nami.org/Blogs/NAMI-Blog/August-2022/Walking-on-a-Tight-Rope-Coping-with-Depression"
           >
  ...
  <div class="card mb-3 librarycard">
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">Understanding Attention-Deficit/Hyperactivity Disorder From Childhood to Adulthood</h5>
        <a className= "articala" 
        href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3724232/"
       >
  ...
  <div class="card mb-3 librarycard">
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">Helping Someone with an Eating Disorder</h5>
        <a className= "articala" 
        href="https://www.helpguide.org/articles/eating-disorders/helping-someone-with-an-eating-disorder.htm"
        >
  ...
  <div class="card mb-3 librarycard">
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">The effect of ADHD on the life of an individual, their family, and community from preschool to adult life</h5>
        <a className= "articala" 
        href="https://adc.bmj.com/content/90/suppl_1/i2"
       >
  ...
  <div class="card mb-3 librarycard">
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">College Students and Eating Disorders</h5>
        <a className= "articala" 
        href="https://childmind.org/article/eating-disorders-and-college/"
        >
  ...
  <div class="card mb-3 librarycard">
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">Taking a Bite Out of Eating Disorders: Facts and Myths</h5>
        <a className= "articala" 
        href="https://kids.frontiersin.org/articles/10.3389/frym.2020.545034"
       >
  ...
  <div class="card mb-3 librarycard">
    <div class="row g-0">
      ...
      <p> <h5 className="articalh5">My Story With Bipolar Disorder</h5>
        <a  className= "articala" 
        href="https://www.nami.org/Personal-Stories/My-Story-with-Bipolar-Disorder"
       >
